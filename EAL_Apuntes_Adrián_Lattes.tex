...
\subsection{Construcción de $\C$ a partir de $\R$}
...
\subsection{El anillo cociente $\K[x]/\left<f\right>$}
...
\fecha{18/02}
\subsection{Elementos algebraicos y transcendentes}
\begin{defin}
...
\begin{proof}\hspace{0pt}
    ...
    \begin{itemize}
        ...
        \item[$n>1$] Por hipótesis de inducción
            ...
            \[\K[\alpha_1,\ldots,\alpha_{n}]=\K[\alpha_1,\ldots,\alpha_{n-1}][\alpha_n]=\K[\alpha_1,\ldots,\alpha_{n-1}](\alpha_n)=\K(\alpha_1,\ldots,\alpha_{n-1})(\alpha_n)=\K(\alpha_1,\ldots,\alpha_n).\]
...
\begin{ej}
    ...
    $\overline{\Q}$ es algebraicamente cerrado.
\end{ej}
