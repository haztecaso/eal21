...
\begin{proof}\hspace{0pt}
    \begin{enumerate}
        ...
        \item[(1)] $f'=p^nt^{p^n-1}-1$ y como $\car{\K}=p$ $f'=-1$. De aquí
            obtenemos que $\text{mcd}(f,f')=1$ y por tanto $f$ tiene sólo raíces
        ...
        \item[(3)] Si $\K$ es un cuerpo finito con $\car{\K}=p$ y $p^n$
            ...
            Lagrange}, si $a\in\K\implies s=\text{ord}(a)=\left|\left<a\right>
...
\begin{obs}
    ...
    \completar %mirar grabación (la captura no se ve bien)
\end{obs}
...
% Resto de la clase: ejercicios 16 y 19
